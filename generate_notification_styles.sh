...
function generate_notif_light_style() {
    ...
    generate_overlay "theming_notif_light_$name_lc" "aicp.notif_light" "$my_path/notif_template" "$out_dir" "com.android.systemui" "$notif_light_overlay_package.$name_lc" "SystemUI" "$product_packages_makefile"
