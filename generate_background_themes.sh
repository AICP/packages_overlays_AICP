...
generate_background_dark "Blue" "#ff000640" "#ff192385" "#ff000640" "#ff000640" "#ff192385"
...
generate_overlay "theming_bg_dark_graylegacy" "aicp.bg_dark" "$template_dark_legacy" "$my_path/BackgroundDark-GrayLegacySettings" "com.android.settings" "$overlay_package_dark.graylegacy" "Settings" "$product_packages_makefile"
